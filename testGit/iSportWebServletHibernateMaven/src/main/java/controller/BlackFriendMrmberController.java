...
@Controller
@RequestMapping("/pages/BlackFriendMrmber.controller")
public class BlackFriendMrmberController {
...
//			}
			...
			if ("SelectBlackFriend".equals(prodaction)) {
				...
				return "blackFriendMemberSelect.select";
				...
				model.addAttribute("select",result);
				return "blackFriendMenberIdSelect.select";
				...
				model.addAttribute("select",result);
				return "blackFriendMemberTypeSelect.select";
			} 
				...
				return "blackFriendMemberSelect.error";
