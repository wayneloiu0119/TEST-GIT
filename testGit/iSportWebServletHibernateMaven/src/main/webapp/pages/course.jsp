	...
	<form action="<c:url value="/pages/course.controller"/>" method="post"
		...
		<table>
			...
			<tr>
				...
				<td><input type="text" name="courseStartDate" value="${param.courseStartDate}"></td>
				<td><span class="error">${errors.xxx02}</span></td>
			</tr>
			<tr>
				<td>CourseEndDate :</td>
				<td><input type="text" name="courseEndDate" value="${param.courseEndDate}"></td>
				<td><span class="error">${errors.xxx03}</span></td>
			</tr>
			<tr>
				<td>CourseWeek :</td>
				<td><input type="text" name="courseWeek" value="${param.courseWeek}"></td>
				<td></td>
			</tr>
			<tr>
				<td>CourseStartTime :</td>
				<td><input type="text" name="courseStartTime" value="${param.courseStartTime}"></td>
				<td></td>
			</tr>
			<tr>
				<td>CourseEndTime :</td>
				<td><input type="text" name="courseEndTime" value="${param.courseEndTime}"></td>
				<td></td>
			</tr>
			<tr>
				<td>Frequency :</td>
				<td><input type="text" name="frequency" value="${param.frequency}"></td>
				<td><span class="error">${errors.xxx04}</span></td>
			</tr>
			<tr>
				<td>CoursePrice :</td>
				<td><input type="text" name="coursePrice" value="${param.coursePrice}"></td>
				<td><span class="error">${errors.xxx05}</span></td>
			</tr>
			<tr>
				<td>Discount :</td>
				<td><input type="text" name="discount" value="${param.discount}"></td>
				<td><span class="error">${errors.xxx06}</span></td>
			</tr>
			<tr>
				<td>DiscountPrice :</td>
				<td><input type="text" name="discountPrice" value="${param.discountPrice}"></td>
			...
			<tr>
				<td>CourseKind :</td>
				<td><input type="text" name="courseKind" value="${param.courseKind}"></td>
				<td></td>
			</tr>
			<tr>
				<td>CoursePic :</td>
				<td><input type="file" name="coursePic" value="${param.coursePic}" 
					accept="image/png,image/gif,image/jpeg"><!--限制只能傳圖片 --></td>
