...
<script language="JavaScript" type="text/javascript">
	function Checkout(cart) {
		...
		document.forms[0].action="<c:url value='/shoppingCart/processOrder.controller' />" ;
		...
		<div
			...
			<div class="col-sm-12 col-md-10 col-md-offset-1">
				<table class="table table-hover">
					<tr>
						<th class="col-sm-1 col-md-1 ">會員姓名：${user.memberName}</th>

					</tr>
					<tr>
						<th class="col-sm-1 col-md-1 ">會員電話：</th>

					</tr>
					<tr>
						<th class="col-sm-1 col-md-1 ">會員姓名：</th>
							...
							<tr>
								...
								<td>
									<button type="button" class="btn btn-warning"
										...
										Cancel Order <span class="glyphicon glyphicon-trash"></span>
									</button>
								</td>
								<td>
