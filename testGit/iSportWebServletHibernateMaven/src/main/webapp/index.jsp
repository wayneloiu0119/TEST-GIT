			...
			<div class="slider">
				<div class="callbacks_container">
					<ul class="rslides" id="slider">
						 <li>	 
							<div class="caption">
							<div class="col-md-6 cap-left wow fadeInDownBig animated animated" data-wow-delay="0.1s">
							...
							<div class="col-md-6 cap-right wow fadeInUpBig animated animated" data-wow-delay="0.1s">
		...
		<!---content--->
			<div class="content">
					...
					<div class="train w3-agile">
						...
						<!---728x90--->
							...
							<div class="train-grids">
								<div class="col-md-3 train-grid wow fadeInLeft animated animated" data-wow-delay="0.1s">
								...
								<div class="col-md-3 train-grid wow fadeInDownBig animated animated" data-wow-delay="0.1s">
									<div class="train-top hvr-bounce-to-right">
										<div class="train-img">
								...
								<div class="col-md-3 train-grid wow fadeInUpBig animated animated" data-wow-delay="0.1s">
									<div class="train-top hvr-bounce-to-right">
										<div class="train-img">
								...
								<div class="col-md-3 train-grid wow fadeInRight animated animated" data-wow-delay="0.1s">
								<div class="train-top hvr-bounce-to-right">
										<div class="train-img">
				...
				<div class="fit-section w3l-layouts">
					<div class="container">
						<div class="fit-grids">
							<div class="col-md-4 fit-grid wow fadeInDownBig animated animated" data-wow-delay="0.1s">
							...
							<div class="col-md-4 fit-grid wow fadeInUpBig animated animated" data-wow-delay="0.1s">
								<img src="<c:url value="/resources/images/f2.jpg"/>" class="img-responsive" alt=""/>
							</div>
							<div class="col-md-4 fit-grid wow fadeInRight animated animated" data-wow-delay="0.1s">
						...
						<div class="fit-grids1">
							<div class="col-md-8 fit-grid2 wow fadeInLeft animated animated" data-wow-delay="0.1s">
								<img src="<c:url value="/resources/images/f3.jpg"/>" class="img-responsive" alt=""/>
							</div>
							<div class="col-md-4 fit-grid1 hvr-bounce-to-bottom wow fadeInDownBig animated animated" data-wow-delay="0.1s">
								<div class="fit-right">
									<h3>Fitness</h3>
									<p>Improving technique that allows to change the body shape and weight and permanently fix the result achieved. It includes physical training combined with properly chosen diet And exercise. </p>
						...
						<div class="fit-grids wow fadeInLeft animated animated" data-wow-delay="0.1s">
						...
						<div class="col-md-4 fit-grid1 hvr-bounce-to-bottom wow fadeInDownBig animated animated" data-wow-delay="0.1s">
							...
							<div class="col-md-8 fit-grid2 wow fadeInUpBig animated animated" data-wow-delay="0.1s">
					...
					<div class="benefits w3l">
						...
						<!---728x90--->
							<div class="benefits-grids">
								<div class="col-md-6 benefits-grid wow fadeInLeft animated animated" data-wow-delay="0.1s">
								...
								<div class="col-md-6 benefits-grid1 wow fadeInRight animated animated" data-wow-delay="0.1s">
			...
			<div class="container">
				...
				<div class="testimonials-grids">
					<div class="col-md-2 testimonials-grid1 test1 wow fadeInDownBig animated animated" data-wow-delay="0.1s">
						<img src="<c:url value="/resources/images/t1.png"/>" class="img-responsive" alt=""/>
					</div>
					<div class="col-md-10 testimonials-grid wow fadeInRight animated animated" data-wow-delay="0.1s">
				...
				<div class="testimonials-grids">
					<div class="col-md-10 testimonials-grid wow fadeInUpBig animated animated" data-wow-delay="0.1s">
						<p>Epsum factorial non deposit quid pro quo hic escorol. Olypian quarrels et gorilla congolium sic ad nauseum. Souvlaki ignitus carborundum e pluribus unum. Defacto lingo est igpay atinlay. Marquee selectus non provisio incongruous feline nolo contendre. Gratuitous octopus niacin, sodium glutimate. Quote meon an estimate et non interruptus stadium.</p>
						<h5>Brightman</h5>
					</div>
					<div class="col-md-2 testimonials-grid1 test wow fadeInLeft animated animated" data-wow-delay="0.1s">
...
<!---footer--->
		<div class="footer-section">
			...
			<div class="footer-grids">
				<div class="col-md-3 footer-grid wow fadeInDownBig animated animated" data-wow-delay="0.1s">
					<h4>About</h4>
				...
				<div class="col-md-3 footer-grid wow fadeInLeft animated animated" data-wow-delay="0.1s">
					<h4>Categories</h4>
					<ul>
						<li>Beauty</li>
						<li>Diet & Fitness</li>
				...
				<div class="col-md-3 footer-grid wow fadeInUpBig animated animated" data-wow-delay="0.1s">
				<h4>Work</h4>
					<ul>
				...
				<div class="col-md-3 footer-grid wow fadeInRight animated animated" data-wow-delay="0.1s">
					<h4>Contact</h4>
	...
	<!---footer--->
	<!--copy-->
	<div class="copy-section wow fadeInDownBig animated animated" data-wow-delay="0.1s">
		<div class="container">
