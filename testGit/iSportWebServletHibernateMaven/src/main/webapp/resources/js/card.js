	...
	module.exports = function() {
		...
		list.i = function(modules, mediaQuery) {
			...
			for(i = 0; i < modules.length; i++) {
				...
				// this implementation is not 100% perfect for weird media query
				// combinations
				// when a module is imported multiple times with different media
				// queries.
				// I hope this will never occur (Hey this way we have smaller
				// bundles)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {// Generated by CoffeeScript
													// 1.10.0
	(function() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/*
	 * ! node.extend Copyright 2011, John Resig Dual licensed under the MIT or
	 * GPL Version 2 licenses. http://jquery.org/license
	 * 
	 * @fileoverview Port of jQuery.extend that actually works on node.js
	 */
...
/***/ (function(module, exports) {
	...
	/**
	 * is.type Test if `value` is a type of `type`.
	 * 
	 * @param {Mixed}
	 *            value value to test
	 * @param {String}
	...
	/**
	 * is.equal Test if `value` is equal to `other`.
	 * 
	 * @param {Mixed}
	 *            value value to test
	 * @param {Mixed}
	...
	/**
	 * is.hosted Test if `value` is hosted by `host`.
	 * 
	 * @param {Mixed}
	 *            value to test
	 * @param {Mixed}
	 *            host host to test with
	...
	/**
	 * is.nil / is.null Test if `value` is null.
	 * 
	 * @param {Mixed}
	 *            value value to test
	...
	/**
	 * is.undef / is.undefined Test if `value` is undefined.
	 * 
	 * @param {Mixed}
	 *            value value to test
	...
	/**
	 * is.args Test if `value` is an arguments object.
	 * 
	 * @param {Mixed}
	 *            value value to test
	...
	/**
	 * is.arguments.empty Test if `value` is an empty arguments object.
	 * 
	 * @param {Mixed}
	 *            value value to test
	...
	/**
	 * is.bool Test if `value` is a boolean.
	 * 
	 * @param {Mixed}
	 *            value value to test
	...
	/**
	 * is.fn / is.function (deprecated) Test if `value` is a function.
	 * 
	 * @param {Mixed}
	 *            value value to test
	...
	/**
	 * is.number Test if `value` is a number.
	 * 
	 * @param {Mixed}
	 *            value value to test
	...
	/**
	 * is.divisibleBy Test if `value` is divisible by `n`.
	 * 
	 * @param {Number}
	 *            value value to test
	 * @param {Number}
	...
	/**
	 * is.integer Test if `value` is an integer.
	 * 
	 * @param value
	 *            to test
	...
	/**
	 * is.maximum Test if `value` is greater than 'others' values.
	 * 
	 * @param {Number}
	 *            value value to test
	 * @param {Array}
	 *            others values to compare with
	...
	/**
	 * is.minimum Test if `value` is less than `others` values.
	 * 
	 * @param {Number}
	 *            value value to test
	 * @param {Array}
	...
	/**
	 * is.even Test if `value` is an even number.
	 * 
	 * @param {Number}
	 *            value value to test
	...
	/**
	 * is.odd Test if `value` is an odd number.
	 * 
	 * @param {Number}
	 *            value value to test
	...
	/**
	 * is.ge Test if `value` is greater than or equal to `other`.
	 * 
	 * @param {Number}
	 *            value value to test
	 * @param {Number}
	...
	/**
	 * is.gt Test if `value` is greater than `other`.
	 * 
	 * @param {Number}
	 *            value value to test
	 * @param {Number}
	...
	/**
	 * is.le Test if `value` is less than or equal to `other`.
	 * 
	 * @param {Number}
	 *            value value to test
	 * @param {Number}
	...
	/**
	 * is.lt Test if `value` is less than `other`.
	 * 
	 * @param {Number}
	 *            value value to test
	 * @param {Number}
	...
	/**
	 * is.within Test if `value` is within `start` and `finish`.
	 * 
	 * @param {Number}
	 *            value value to test
	 * @param {Number}
	 ...
	 * @param {Mixed}
	 *            value value to test
	 * @return {Boolean} true if 'value' is a hex encoded string, false
	 *         otherwise
	 * @api public
	 */
	...
	/**
	 * is.symbol Test if `value` is an ES6 Symbol
	 * 
	 * @param {Mixed}
	 *            value value to test
