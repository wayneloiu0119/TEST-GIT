...
<link href='<c:url value="/resources/css/login.css"/>' rel="stylesheet"  type="text/css" media="all" /> <!-- Style-CSS -->
<link href='<c:url value="/resources/css/font-awesome.css"/>' rel="stylesheet" ><!-- Font-Awesome-Icons-CSS -->
<!-- web-fonts -->
	...
	<nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header wow fadeInLeft animated animated" data-wow-delay="0.1s">
         ...
         <h1><a class="navbar-brand" href="index.jsp"><span><img src="resources/images/e.png"/></span> iSport</a></h1>
        </div>
...
<%-- <div data-vide-bg="<c:url value="/resources/video/training"/>"> --%>
	...
	<script src='<c:url value="/resources/js/jquery-2.1.4.min.js" />'></script><!--common-js-->
	<script src='<c:url value="/resources/js/jquery.vide.min.js" />'></script><!--video-js-->
</body>
</html>