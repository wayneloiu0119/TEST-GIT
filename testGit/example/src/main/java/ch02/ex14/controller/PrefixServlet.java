...
@WebServlet("/ch02/ex14/*")
//           /ch02/ex14/PSY/abula.009
public class PrefixServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		  // 設定回應資料的格式為text/html，回應之文字資料的編碼為UTF-8(charset=UTF-8)
		   ...
		   out.print("<H2><font color='DarkGreen'>ServletPath =" + request.getServletPath()  +" </font></H2>");
		   out.print("<H2><font color='DarkGreen'>Path Info=" + request.getPathInfo() +" </font></H2>");
